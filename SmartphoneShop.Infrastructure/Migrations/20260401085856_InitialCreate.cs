        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScreenSize = table.Column<decimal>(type: "decimal(3,1)", nullable: true),
                    ...
                    Processor = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MainCamera = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    WaterResistance = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComparisonLists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ComparisonLists_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SmartphoneModel = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Favorites_Smartphones_SmartphoneId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItems_Smartphones_SmartphoneId",
                        column: x => x.SmartphoneId,
                        principalTable: "Smartphones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ComparisonItems_ComparisonLists_ComparisonListId",
                        column: x => x.ComparisonListId,
                        principalTable: "ComparisonLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComparisonItems_Smartphones_SmartphoneId",
                        column: x => x.SmartphoneId,
                        principalTable: "Smartphones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItems_SmartphoneId",
                table: "CartItems",
                column: "SmartphoneId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComparisonItems_ComparisonListId",
                table: "ComparisonItems",
                column: "ComparisonListId");

            migrationBuilder.CreateIndex(
                name: "IX_ComparisonItems_SmartphoneId",
                table: "ComparisonItems",
                column: "SmartphoneId");

            migrationBuilder.CreateIndex(
                name: "IX_ComparisonLists_SessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_SmartphoneId",
                table: "Favorites",
                column: "SmartphoneId");

            migrationBuilder.CreateIndex(
                name: "IX_Favorites_UserId_SmartphoneId",
                table: "Favorites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Smartphones_IsFeatured",
                table: "Smartphones",
                column: "IsFeatured");
        }
